            ...
            try{
                gm(bitmap).size(function (err, size) {
                    if (!err) {
                        ...
                        gm(bitmap).scale(scaleWidth, scaleHeight).toBuffer('PNG',function (err, scaledBuff) {
                            if(!err){
                                gm(scaledBuff).crop(Target_Width, Target_Height).toBuffer('PNG',function(err,croppedBuff){
                                    if(!err){
