                            ...
                            if (!err) {
                                if (InsertResult != null) {
                                    if (InsertResult.affectedRows > 0) {
                                        ...
                                        var selectqry = 'Select tlocations.TID,MasterID,EZEID,LocTitle,Latitude,Longitude,Altitude,AddressLine1,AddressLine2,Area,StateID,CountryID,PostalCode,PIN,EMailID,EMailVerifiedID,PhoneNumber,MobileNumber, LaptopSLNO,VehicleNumber,CreatedDate,LUDate,Website,SeqNo,Picture,PictureFileName,locSetting.ParkingStatus,locSetting.OpenStatus,locSetting.WorkingHours,locSetting.SalesEnquiryMailID,locSetting.HomeDeliveryMailID,locSetting.ReservationMailID,locSetting.SupportMailID,locSetting.CVMailID from tlocations left outer join tlcoationsettings  locSetting on locSetting.LocID= tlocations.TID';
                                        if (TID == 0) {
