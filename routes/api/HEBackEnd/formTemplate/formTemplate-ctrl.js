...
formTemplateCtrl.saveFormTemplate = function (req, res, next) {
    ...
    var error_logger = {
        details: 'formTemplate/formTemplate-Ctrl : formTemplate.saveFormTemplate',
    }
...
formTemplateCtrl.updateFormTemplate = function (req, res, next) {
    ...
    var error_logger = {
        details: 'formTemplate/formTemplate-Ctrl : formTemplate.updateFormTemplate',
    }
...
formTemplateCtrl.getFormTemplate = function (req, res, next) {
    ...
    var error_logger = {
        details: 'formTemplate/formTemplate-Ctrl : formTemplate.getFormTemplate',
    }
...
formTemplateCtrl.getFormTemplateList = function (req, res, next) {
    ...
    var error_logger = {
        details: 'formTemplate/formTemplate-Ctrl : formTemplate.getFormTemplateList',
    }
...
formTemplateCtrl.deleteFormTemplate = function (req, res, next) {
    ...
    var error_logger = {
        details: 'formTemplate/formTemplate-Ctrl : formTemplate.deleteFormTemplate',
    }
