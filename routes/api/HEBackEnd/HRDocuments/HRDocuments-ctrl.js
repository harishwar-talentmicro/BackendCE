...
HRDocsCtrl.saveHRDocs = function (req, res, next) {
    ...
    var error_logger = {
        details: 'HRDocuments/HRDocuments-Ctrl : HRDocsCtrl.saveHRDocs',
    }
...
HRDocsCtrl.getHRDocList = function (req, res, next) {
    ...
    var error_logger = {
        details: 'HRDocuments/HRDocuments-Ctrl : HRDocsCtrl.getHRDocList',
    }
...
HRDocsCtrl.deleteHRDocs = function (req, res, next) {
    ...
    var error_logger = {
        details: 'HRDocuments/HRDocuments-Ctrl : HRDocsCtrl.deleteHRDocs',
    }
