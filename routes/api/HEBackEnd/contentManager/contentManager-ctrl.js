...
contentManagerCtrl.saveContent = function (req, res, next) {
    ...
    var error_logger = {
        api_name: '/contentManager',
        details: 'contentManager/contentManager-Ctrl : contentManager.saveContent',
    }
                        ...
                        req.db.query(procQuery, function (err, contentResult) {
                            try {
                                ...
                                if (!err && contentResult && contentResult[0] && contentResult[0][0]) {
                                    var messagePayload = {
                                        message : contentResult[0][0].message,
...
contentManagerCtrl.findDocument = function (req, res, next) {
    ...
    var error_logger = {
        api_name: '/contentManager',
        details: 'contentManager/contentManager-Ctrl : contentManager.findDocument',
    }
...
contentManagerCtrl.getDocumentDetails = function (req, res, next) {
    ...
    var error_logger = {
        api_name: '/details',
        details: 'contentManager/contentManager-Ctrl : contentManager.getDocumentDetails',
    }
...
contentManagerCtrl.deleteDoc = function (req, res, next) {
    ...
    var error_logger = {
        api_name: '/contentManagerdeleteApi',
        details: 'contentManager/contentManager-Ctrl : contentManager.deleteDoc',
    }
    try {
        var response = {
            status: false,
...
contentManagerCtrl.findRelatedDocument = function (req, res, next) {
    ...
    var error_logger = {
        api_name: '/relatedDocument/find',
        details: 'contentManager/contentManager-Ctrl : contentManager.findRelatedDocument',
    }
    try {
        var response = {
            status: false,
...
contentManagerCtrl.getRelatedDocument = function (req, res, next) {
    ...
    var error_logger = {
        api_name: '/relatedDocuments',
        details: 'contentManager/contentManager-Ctrl : contentManager.getRelatedDocument',
    }
...
contentManagerCtrl.saveRelatedDocument = function (req, res, next) {
    ...
    var error_logger = {
        api_name: '/relatedDocument',
        details: 'contentManager/contentManager-Ctrl : contentManager.saveRelatedDocument',
    }
...
contentManagerCtrl.deleteRelatedDocument = function (req, res, next) {
    ...
    var error_logger = {
        api_name: '/relatedDocument',
        details: 'contentManager/contentManager-Ctrl : contentManager.deleteRelatedDocument',
    }
    try {
        var response = {
            status: false,
...
contentManagerCtrl.savedocumentFeedback = function (req, res, next) {
    ...
    var error_logger = {
        api_name: '/docFeedback',
        details: 'contentManager/contentManager-Ctrl : contentManager.savedocumentFeedback',
    }
    try {
        var response = {
            status: false,
...
contentManagerCtrl.getdocumentUpdateFeedback = function (req, res, next) {
    ...
    var error_logger = {
        api_name: '/docFeedback',
        details: 'contentManager/contentManager-Ctrl : contentManager.getdocumentUpdateFeedback',
    }
...
contentManagerCtrl.docFeedbackReadReport = function(req,res,next){
    var response = {
        status : false,
        message : "Invalid token",
        data : null,
    ...
    if (!validationFlag){
        ...
        req.st.validateToken(req.query.token,function(err,tokenResult){
            if((!err) && tokenResult){
                ...
                var procQuery = 'CALL wm_get_informationFinderUpdateReport( ' + procParams.join(',') + ')';
                console.log(procQuery);
                req.db.query(procQuery,function(err,documentResult){
                    console.log(err);
                    if(!err && documentResult && documentResult[0] && documentResult[0][0] ){
