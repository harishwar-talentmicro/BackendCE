            ...
            if((!err) && tokenResult){
                ...
                zlib.unzip(decryptBuf, function (_, resultDecrypt) {
                    ...
                    if (!validationFlag){
                        ...
                        var keywordsParams=[
                            req.st.db.escape(req.query.token),
                            req.st.db.escape(ITHelpDeskFormId),
                         ...
                         * @type {string}
                         */
                        var procQuery = 'CALL HE_save_ITHelpdesk_new( ' + procParams.join(',') + '); CALL wm_update_formKeywords(' + keywordsParams.join(',') + ');';
                        ...
                        req.db.query(procQuery,function(err,results){
                            if(!err && results && results[0] ){
                                ...
                                response.message = "IT helpdesk request saved successfully";
                                response.error = null;
                                response.data = {
                                    messageList: {
                                ...
                                response.message = "Error while saving helpdesk request";
                                response.error = null;
                                response.data = null;
