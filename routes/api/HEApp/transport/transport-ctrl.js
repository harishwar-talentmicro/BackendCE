            ...
            if((!err) && tokenResult){
                ...
                zlib.unzip(decryptBuf, function (_, resultDecrypt) {
                    ...
                    if (!req.body.travelTime) {
                        error.travelTime = 'Invalid travelTime';
                        validationFlag *= false;
                    }
                    ...
                    if (!validationFlag){
                        ...
                        req.body.typeOfTransport = req.body.typeOfTransport ? req.body.typeOfTransport : 1;
                        ...
                        var procParams = [
                            ...
                            req.st.db.escape(req.body.typeOfTransport),
                            req.st.db.escape(req.body.travelTime),
                        ...
                        var keywordsParams=[
                            req.st.db.escape(req.query.token),
                            req.st.db.escape(transportFormId),
                         ...
                         * @type {string}
                         */
                        var procQuery = 'CALL HE_Save_TransportRequest_new( ' + procParams.join(',') +');CALL wm_update_formKeywords(' + keywordsParams.join(',') + ');';
                        ...
                        req.db.query(procQuery,function(err,results){
                            if(!err && results && results[0] ){
                                ...
                                response.message = "Transport request saved successfully";
                                response.error = null;
                                response.data = {
                                    messageList: {
                                ...
                                response.message = "Error while saving transport request";
                                response.error = null;
                                response.data = null;
