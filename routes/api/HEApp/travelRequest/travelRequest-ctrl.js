...
travelRequestCtrl.saveTravelRequest = function(req,res,next){
    ...
    req.st.validateToken(req.query.token,function(err,tokenResult){
        if((!err) && tokenResult){
            ...
            req.body.requiredAdvanceAmount = req.body.requiredAdvanceAmount ? req.body.requiredAdvanceAmount : 0;
             ...
             * @type {string}
             */
            var procQuery = 'CALL HE_save_travelRequest( ' + procParams.join(',') + ')';
