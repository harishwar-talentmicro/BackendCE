        ...
        try {
            req.st.validateToken(req.query.token, function (err, tokenResult) {
                if ((!err) && tokenResult) {
                    ...
                    var proc = 'select a.picture from tmaster a,theusers b where b.heMasterId=' + req.body.heMasterId + ' and a.tId=b.userMasterId and b.employeeCode=' + rewardRecognition[0].EmployeeCode;
                    req.db.query(proc, function (err, results) {
                        ...
                        var attachFile = new Promise(function (resolve, reject) {
                                ...
                                circleImage.then(function (resp) {
                                    setTimeout(function () {
                                        ...
                                        Jimp.read("/home/ezeonetalent/ezeone1/api/routes/api/HEApp/greeting/" + rewardRecognition[0].UserName + ".png", function (err, penna) {
                                            ...
                                            Jimp.read("https://storage.googleapis.com/ezeone/3113d43c-c01a-4639-94d7-9040f919d853.png", function (err, lenna) {
                            ...
                            // setTimeout(function () {
                            var attachment = {
                                path: "/home/ezeonetalent/ezeone1/api/routes/api/HEApp/greeting/lena-small-bw" + rewardRecognition[0].UserName + ".png",
                                extension: 'png',
                                fileName: 'gunasheel'
                            };
                            ...
                            uploadDocumentToCloud(aUrl, readStream, function (err) {
                                if (!err) {
                                    console.log(aUrl)
                                    fs.unlinkSync("/home/ezeonetalent/ezeone1/api/routes/api/HEApp/greeting/lena-small-bw" + rewardRecognition[0].UserName + ".png");
                                    fs.unlinkSync("/home/ezeonetalent/ezeone1/api/routes/api/HEApp/greeting/" + rewardRecognition[0].UserName + ".png");
                                }
                                else {
