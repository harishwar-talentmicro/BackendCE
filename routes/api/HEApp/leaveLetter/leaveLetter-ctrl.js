...
leaveLetterCtrl.saveLeaveLetter = function(req,res,next){
    ...
    if (!req.body.leaveType) {
        error.leaveType = 'Invalid leaveType';
        validationFlag *= false;
    }

    if (!req.body.leaveStartDate) {
        error.leaveStartDate = 'Invalid leaveStartDate';
        validationFlag *= false;
    }
        ...
        req.st.validateToken(req.query.token,function(err,tokenResult){
            if((!err) && tokenResult){
                ...
                var procParams = [
                    ...
                    req.st.db.escape(req.body.leaveType),
                    req.st.db.escape(req.body.leaveStartDate),
                    req.st.db.escape(req.body.leaveDays),
                ...
                req.db.query(procQuery,function(err,results){
                    ...
                    if(!err && results && results[0] ){
                        ...
                        response.message = "Leave letter saved successfully";
                        response.error = null;
                        response.data = {
                            messageList: {
                        ...
                        response.message = "Error while saving leave letter";
                        response.error = null;
                        response.data = null;
