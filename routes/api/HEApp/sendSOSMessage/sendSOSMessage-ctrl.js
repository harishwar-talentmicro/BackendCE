            ...
            if((!err) && tokenResult){
                ...
                zlib.unzip(decryptBuf, function (_, resultDecrypt) {
                    ...
                    if (!validationFlag){
                         ...
                         * @type {string}
                         */
                        var procQuery = 'CALL HE_save_sendSOSMessage( ' + procParams.join(',') +');CALL wm_update_formKeywords(' + keywordsParams.join(',') + ');';
                        ...
                        req.db.query(procQuery,function(err,results){
                            ...
                            if(!err && results && results[0] ){
                                ...
                                response.message = "SOS message sent successfully";
                                response.error = null;
                                response.data = {
                                    messageList: {
                                ...
                                response.message = "Error while sending SOS message";
                                response.error = null;
                                response.data = null;
...
module.exports = sendSOSMessageCtrl;