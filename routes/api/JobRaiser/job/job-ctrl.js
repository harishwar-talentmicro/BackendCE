...
jobCtrl.saveJobDefaults = function (req, res, next) {
    var error_logger = {
        details: 'jobCtrl.saveJobDefaults'
    }
    try {
        var error_response = {
            status: false,
...
jobCtrl.getJobDefaultMemberList = function (req, res, next) {
    try {
        var error_logger = {
            details: 'jobCtrl.getJobDefaultMemberList'
        }
...
jobCtrl.getJobDefaults = function (req, res, next) {
    try {
        var error_logger = {
            details: 'jobCtrl.getJobDefaults'
        }
...
jobCtrl.getcontactlist = function (req, res, next) {
    try {
        var error_logger = {
            details: 'jobCtrl.getcontactlist'
        }
...
jobCtrl.saveRequirement = function (req, res, next) {
    try {
        var error_logger = {
            details: 'jobCtrl.saveRequirement'
        }
...
jobCtrl.deleteReqContacts = function (req, res, next) {
    try {
        var error_logger = {
            details: 'jobCtrl.deleteReqContacts'
        }
...
jobCtrl.deleteMainContacts = function (req, res, next) {
    try {
        var error_logger = {
            details: 'jobCtrl.deleteMainContacts'
        }
...
jobCtrl.deleteMainBranches = function (req, res, next) {
    try {
        var error_logger = {
            details: 'jobCtrl.deleteMainBranches'
        }
...
jobCtrl.getRequirementDetails = function (req, res, next) {
    try {
        var error_logger = {
            details: 'jobCtrl.getRequirementDetails'
        }
...
jobCtrl.getJdTemplateDetails = function (req, res, next) {
    try {
        var error_logger = {
            details: 'jobCtrl.getJdTemplateDetails'
        }
...
jobCtrl.manpowerRequirementStatus = function (req, res, next) {
    try {
        var error_logger = {
            details: 'jobCtrl.manpowerRequirementStatus'
        }
...
jobCtrl.getClientManagerList = function (req, res, next) {
    try {
        var error_logger = {
            details: 'jobCtrl.getClientManagerList'
        }
...
jobCtrl.getrequirementListMobile = function (req, res, next) {
    try {
        var error_logger = {
            details: 'jobCtrl.getrequirementListMobile '
        }
...
jobCtrl.getRequirementContactsOfBranchForMobile = function (req, res, next) {
    try {
        var error_logger = {
            details: 'jobCtrl.getRequirementContactsOfBranchForMobile'
        }
