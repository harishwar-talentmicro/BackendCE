                ...
                req.db.query(procQuery,function(err,result){
                    ...
                    if(!err && result){
                        ...
                        for(var j=0; j<result[10].length; j++){
                            var res1={};
                            res1.educationId=result[10][j].educationId;
                            res1.educationTitle=result[10][j].EducationTitle;
                            res1.specialization=result[10][j].specialization ? JSON.parse(result[10][j].specialization):[];
                            output1.push(res1); 
                        };
