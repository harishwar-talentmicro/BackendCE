        ...
        req.st.validateToken(req.query.token,function(err,tokenResult){
            if ((!err) && tokenResult) {
                ...
                req.db.query(procQuery,function(err,result){
                    console.log(err);
                    if(!err && result ||(result[0] && result[0][0]) ||(result[1] && result[1][0]) ||(result[2] && result[2][0])||(result[3] && result[3][0])||(result[4] && result[4][0])|| (result[5] && result[5][0])){
