...
billingCtrl.billingFilter = function (req, res, next) {
    try {
        var error_logger = {
            details: 'billingCtrl.billingFilter'
        }
...
billingCtrl.billTaxTemplate = function (req, res, next) {
    try {
        var error_logger = {
            details: 'billingCtrl.billTaxTemplate'
        }
...
billingCtrl.billmasterTaxTypes = function (req, res, next) {
    try {
        var error_logger = {
            details: 'billingCtrl.billmasterTaxTypes'
        }
...
billingCtrl.billInvoiceTemplate = function (req, res, next) {
    try {
        var error_logger = {
            details: 'billingCtrl.billInvoiceTemplate'
        }
...
billingCtrl.invoiceMailerPreview = function (req, res, next) {
    try {
        var error_logger = {
            details: 'billingCtrl.invoiceMailerPreview'
        }
...
billingCtrl.InoviceNumberGeneration = function (req, res, next) {
    try {
        var error_logger = {
            details: 'billingCtrl.InoviceNumberGeneration'
        }
...
billingCtrl.invoiceApplyTax = function (req, res, next) {
    try {
        var error_logger = {
            details: 'billingCtrl.invoiceApplyTax'
        }
...
billingCtrl.invoiceBillGenerate = function (req, res, next) {
    try {
        var error_logger = {
            details: 'billingCtrl.invoiceBillGenerate'
        }
...
billingCtrl.savePaceReqAppBilling = function (req, res, next) {
    try {
        var error_logger = {
            details: 'billingCtrl.savePaceReqAppBilling'
        }
...
billingCtrl.getPaceReqAppBilling = function (req, res, next) {
    try {
        var error_logger = {
            details: 'billingCtrl.getPaceReqAppBilling'
        }
...
billingCtrl.savePaceFollowUpNotes = function (req, res, next) {
    try {
        var error_logger = {
            details: 'billingCtrl.savePaceFollowUpNotes'
        }
...
billingCtrl.getPaceFollowUpNotes = function (req, res, next) {
    try {
        var error_logger = {
            details: 'billingCtrl.getPaceFollowUpNotes'
        }
...
billingCtrl.billingFilterNew = function (req, res, next) {
    try {
        var error_logger = {
            details: 'billingCtrl.billingFilterNew'
        }
...
billingCtrl.imapFinally = function (req, res, next) {
    try {
        var error_logger = {
            details: 'billingCtrl.imapFinally'
        }
