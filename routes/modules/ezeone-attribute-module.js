...
EzeoneAttrbt.prototype.dialerAppVersionCode = function(req,res,next){
    ...
    switch(req.platform){
        case 'ios':
             ...
             * If IOS version is not supported
             */
            if(req.CONFIG.VERSION_LIST.dialerIOS[0].indexOf(parseInt(req.query.versionCode)) == -1 && req.CONFIG.VERSION_LIST.dialerIOS[1].indexOf(parseInt(req.query.versionCode)) == -1 ){
                rtnMessage.data  = {
                    versionStatus : 2,
                    versionMessage : "Please update your application to latest version to continue using it"
                };
            ...
            else if(req.CONFIG.VERSION_LIST.dialerIOS[1].indexOf(parseInt(req.query.versionCode)) == -1){
                rtnMessage.data = {
                    versionStatus : 1,
                    versionMessage : "New update available. Please update your application to latest version"
                }
        ...
        case 'android':
             ...
             * If Android version is not supported
             */
            if(req.CONFIG.VERSION_LIST.dialerANDROID.indexOf(parseInt(req.query.versionCode)) == -1){
                rtnMessage.data = {
                    versionStatus : 2,
                    versionMessage : "Please update your application to latest version to continue using it"
                };
                ...
                rtnMessage.data = {
                    versionStatus : (req.CONFIG.VERSION_LIST.dialerANDROID.length ==
                    (req.CONFIG.VERSION_LIST.dialerANDROID.indexOf(parseInt(req.query.versionCode)) + 1)) ? 0 : 1,
                    versionMessage :"New update available. Please update your application to latest version"
