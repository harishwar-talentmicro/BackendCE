...
//var ejs = require('ejs');
//
//var genericTemplate = fs.readFileSync('./mail/templates/generic.html','utf-8');
//var jobTemplate = fs.readFileSync('./mail/templates/job/individual-candidate-job-suggestion.html','utf-8');
//console.log(genericTemplate);
//var pseudoTemplate = ejs.render(genericTemplate,{ jobTemplate : jobTemplate});
//
////fs.writeFileSync('test1.html',pseudoTemplate);
//
//fs.writeFileSync('test.html',ejs.render(pseudoTemplate,{
//    firstName : "Harish",
//    companyName : "HCL Technologies",
//    jobTitle : "Software Developer",
//    jobCode : "SD21",
//    keySkills : "Java, J2EE, Hibernate",
//    jobId : 21
//}));

var sendgrid = require('sendgrid')('ezeid', 'Ezeid2015');
var fileContent =fs.readFileSync('test1.pdf');

var mailOptions = new sendgrid.Email({
    from: 'noreply@ezeone.com', // sender address
    to: ['indrajeetnagda@gmail.com'], // list of receivers
    subject: 'Test email to get attachment', // Subject line
    text: "Hi this is a test mail with attachment", // plaintext body
    html: "Hi this is a test mail with attachment" // html body,
    //files : []
});

mailOptions.addFile({filename : 'Report.pdf',content : fileContent});
