(function(){
    angular.module('ezeidApp').controller('HomeDeliveryCtrl',[
        ...
        function (
            ...
            /**
             *
             * homeDelivery items present for this user
             * @type {Array}
             */
            $scope.moduleItems = [];
            ...
            $scope.modalBox = {
                ...
                tx : {
                    ...
                    folderRule : 0,
                    message : '',
                    messageType : (parseInt($rootScope._userInfo.HomeDeliveryItemListType) !== NaN) ?
                        parseInt($rootScope._userInfo.HomeDeliveryItemListType) : 0,
                    latitude : 0,
                    longitude : 0,
                    duration : 0,
                    durationScale : 0,
            ...
            $scope.resetModalBox = function(){
                $scope.modalBox = {
                    ...
                    tx : {
                        ...
                        message : '',
                        messageType : (
                            parseInt($rootScope._userInfo.HomeDeliveryItemListType) !== NaN)
                            ? parseInt($rootScope._userInfo.HomeDeliveryItemListType) : 0,
                        latitude : 0,
                        longitude : 0,
                        duration : 0,
            ...
            /**
             * Loads FolderRules for homeDelivery
             * @return {*|promise}
             */
