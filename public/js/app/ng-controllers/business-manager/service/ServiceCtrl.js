(function(){
    angular.module('ezeidApp').controller('ServiceCtrl',[
        ...
        function (
            ...
            $scope.serviceItemListType = 0; // Hardcoded message only
            ...
            var getSubUserList = function(){
                ...
                $http({
                    ...
                    if(resp && resp.length > 0 && resp !== 'null'){
                        ...
                        if(index !== -1){
                            var userFolders = (resp[index].ServiceIDs) ? resp[index].ServiceIDs.split(',') : [];
            ...
            $scope.$on(
                ...
                function handleDestroyEvent() {
                    ...
                    // */
                    //0 = $scope._tempSalesItemListType;
                }
            );
